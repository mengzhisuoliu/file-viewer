...
```bash
npm install -D file-viewer-copy-assets@2.2.1
npx --yes file-viewer-copy-assets@2.2.1 ./public/file-viewer
```
...
pnpm dlx file-viewer-copy-assets@2.2.1 ./public/file-viewer
```
