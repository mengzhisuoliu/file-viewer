...
[data-viewer-theme='dark'] .umd-viewer{background:#101820;color:#e5edf6}[data-viewer-theme='dark'] .umd-toolbar,[data-viewer-theme='dark'] .umd-toc{background:rgba(15,23,42,.92);border-color:rgba(148,163,184,.18)}
