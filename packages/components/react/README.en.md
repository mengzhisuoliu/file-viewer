...
```bash
npm i @file-viewer/react @file-viewer/core @file-viewer/vite-plugin @file-viewer/preset-office
```
...
```bash
npm i @file-viewer/react @file-viewer/core @file-viewer/vite-plugin @file-viewer/preset-all
```
