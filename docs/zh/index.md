...
<img src="/_media/file-viewer-demo-v2.2.2-zh.gif" alt="Flyfish Viewer v2.2.2 中文 Demo：沉浸式文档画布、文件胶囊、样例选择器与格式工具栏" width="1200" height="750" loading="lazy" />
<figcaption>最新中文 Demo：文件胶囊会与顶部操作栏自然融合，点击文件名或“样例”即可打开带格式图标的完整样例库。</figcaption>
</figure>
